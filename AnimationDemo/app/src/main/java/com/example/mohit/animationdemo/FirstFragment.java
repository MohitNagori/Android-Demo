...
public class FirstFragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view.findViewById(R.id.xAxisFlip).setOnClickListener(this);
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.fragmentSlideIn: {
                ...
                ft.replace(R.id.flFragments, new SecondFragment(), "SecondFragment");
                ft.commit();
            ...
            case R.id.xAxisFlip: {
                FragmentTransaction ft = getFragmentManager().beginTransaction();
                ft.setCustomAnimations(R.animator.flip_up_in, R.animator.flip_up_out);
                ft.replace(R.id.flFragments, new SecondFragment(), "SecondFragment");
                ft.commit();
                getFragmentManager().executePendingTransactions();
                break;
